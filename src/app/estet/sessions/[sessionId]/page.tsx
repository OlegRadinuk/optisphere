...
export default function EstetSessionDetailPage({ params }: { params: Promise<{ sessionId: string }> }) {
  ...
  useEffect(() => {
    fetch(`/api/estet/sessions/${sessionId}`)
  ...
  return (
    <div>
      ...
      <Link
        href="/estet/sessions"
        style={{ color: PRIMARY, fontSize: 13, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 4, marginBottom: 16 }}
