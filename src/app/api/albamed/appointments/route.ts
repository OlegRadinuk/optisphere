...
export async function GET(req: NextRequest): Promise<Response> {
  ...
  try {
    ...
    const week = searchParams.get("week") // YYYY-MM-DD of any day in the week
    ...
    console.error("[albamed/appointments GET]", e)
...
export async function POST(req: NextRequest): Promise<Response> {
  ...
  try {
    ...
    console.error("[albamed/appointments POST]", e)
    return NextResponse.json({ error: "Server error" }, { status: 500 })
  }
}
...
export async function PATCH(req: NextRequest): Promise<Response> {
  ...
  try {
    ...
    if (e instanceof z.ZodError) return NextResponse.json({ error: e.issues }, { status: 400 })
    console.error("[albamed/appointments PATCH]", e)
    return NextResponse.json({ error: "Server error" }, { status: 500 })
  }
}
...
export async function DELETE(req: NextRequest): Promise<Response> {
  ...
  try {
    ...
    console.error("[albamed/appointments DELETE]", e)
    return NextResponse.json({ error: "Server error" }, { status: 500 })
  }
}
